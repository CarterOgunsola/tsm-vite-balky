...
function toggleView(defaultView = "grid") {
  ...
  const applyViewChange = (newView) => {
    const elements = document.querySelectorAll(
      ".work-cms-list, .work-cms-item, .work-cms-num, .work-cms_thumb-main, .work-cms_content, .work-cms-year, .work-cms-line.top, .work-cms-line.btm, .section.cc-work-hero, .work-view_link, .navigation-main, .work-cms_content-btm-list, .work-cms_content-btm-grid, .section.cc-work-hero-top, .filter-menu-parent, .filter-list-parent, .work-cms_icon",
    );
